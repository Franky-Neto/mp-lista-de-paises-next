...
export default function CountryCard({ name, ptName, flag, flagAlt, cca3 }: {name: string, ptName: string, flag: string, flagAlt: string, cca3: string}) {
    return (
         <Link href={`/pais/${cca3}`} key={name}>
        <article
